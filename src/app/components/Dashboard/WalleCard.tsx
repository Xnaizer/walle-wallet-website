...
export default function WalleCard({
  ...
  //   if (
  //     cardName.toLowerCase().includes("main") ||
  //     cardName.toLowerCase().includes("primary")
  //   ) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-700 shadow-xl`}
      ></div>
      ...
      <div className="relative z-10 p-6 h-full flex flex-col justify-between text-white">
        ...
        {/* <div className="flex-1 flex items-center">
          <div>
            ...
            <div className="text-white/70 text-sm">{card.expiryDate}</div>
          </div>
        </div> */}
        ...
        {showBalance && (
          <div className="flex justify-between items-end">
            ...
            <div className="text-white/60 text-sm font-bold">WALLE</div>
          </div>
        )}
      </div>
